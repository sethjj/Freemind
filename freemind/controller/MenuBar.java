...
import freemind.database.actions.ArchiveMenuExtender;
...
//    public static final String MODES_MENU = MENU_BAR_PREFIX+"modes/";
    ...
    public static final String ARCHIVE_MENU = MENU_BAR_PREFIX + "archive/";
    ...
    private ArchiveMenuExtender ame;
    Controller c;
...
//		filemenu.setMnemonic(KeyEvent.VK_F);
        ...
        menuHolder.addMenu(filemenu, FILE_MENU + ".");
...
//		mapsmenu.setMnemonic(KeyEvent.VK_M);
        ...
        if( ame == null )   {
            ame = new ArchiveMenuExtender(this);
        }
        if( ame.isVisible() )
            this.add(ame.createArchiveMenu(newModeController));
        //
