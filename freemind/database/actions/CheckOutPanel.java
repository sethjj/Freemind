...
class CheckOutPanel extends JDialog
    ...
    public CheckOutPanel(Frame aFrame, String[] maps, DataBaseReader dbr) {
        super(aFrame, true);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if ( command.equals("comboBoxChanged" ) ) {
            current = dbr.getCurrentDateForMap(getMap());
            baseLine = dbr.getBaseLineDateForMap(getMap());
            currentLabel.setText(current.getDateStr());
            baseLineLabel.setText(baseLine.getDateStr());
         }   
    ...
    public JPanel createSelectionPanel() {
        ...
        current = dbr.getCurrentDateForMap(getMap());
        currentLabel = new JLabel(current.getDateStr());
        aPanel.add(currentLabel);
        //
        aPanel.add(baseLineButton);
        baseLine = dbr.getBaseLineDateForMap(getMap());
        baseLineLabel = new JLabel(baseLine.getDateStr());
        aPanel.add(baseLineLabel);
        //
